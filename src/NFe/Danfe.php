...
class Danfe extends DaCommon
{
    ...
    protected function monta(
        ...
        $y = $this->dadosAdicionais($x, $y, $this->hdadosadic+20);
    ...
    protected function itens($x, $y, &$nInicio, $hmax, $pag = 0, $totpag = 0, $hCabecItens = 7)
    {
        ...
        foreach ($this->det as $d) {
            if ($i >= $nInicio) {
                ...
                $uTribTemp = $prod->getElementsByTagName("uTrib")->item(0)->nodeValue;
                $uComTemp = $prod->getElementsByTagName("uCom")->item(0)->nodeValue;
